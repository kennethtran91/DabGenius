...
u1 = User.create!(username: Faker::Name.name, password: "rapgod")
u2 = User.create!(username: Faker::Name.name, password: "rapgod")
u3 = User.create!(username: Faker::Name.name, password: "rapgod")
u4 = User.create!(username: Faker::Name.name, password: "rapgod")
u5 = User.create!(username: Faker::Name.name, password: "rapgod")
u6 = User.create!(username: Faker::Name.name, password: "rapgod")
u7 = User.create!(username: Faker::Name.name, password: "rapgod")
u8 = User.create!(username: Faker::Name.name, password: "rapgod")
u9 = User.create!(username: Faker::Name.name, password: "rapgod")
